...
NimbleController::NimbleController(Pinetime::System::SystemTask& systemTask,
  ...
  : systemTask {systemTask},
    ...
    rawPpgService {*this, heartRateController},
  ...
  switch (event->type) {
    ...
    case BLE_GAP_EVENT_SUBSCRIBE:
      ...
      if (event->subscribe.reason == BLE_GAP_SUBSCRIBE_REASON_TERM) {
        ...
        rawPpgService.UnsubscribeNotification(event->subscribe.attr_handle);
        ...
        rawPpgService.SubscribeNotification(event->subscribe.attr_handle);
