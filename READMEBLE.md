...
- El firmware quedó ajustado a **25 Hz** (una muestra cada **40 ms**) en el procesamiento PPG.
- El sensor HRS3300 quedó con `HWT = 0 ms` para no introducir espera adicional entre ciclos ADC.
- Si el enlace BLE o el host no alcanzan el ritmo, `sample_counter` te permite detectar pérdidas.
